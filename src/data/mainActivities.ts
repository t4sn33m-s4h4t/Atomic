...
const mainActivities: CardProps[] = [
  {
    ...
    href: "event",
    desc: "ABSC hosts electrifying national events like FTMPC 3.0, INIT 3.0, and Thynk 2.0, pushing boundaries in technology engagement.",
  ...
  },
  {
    ...
    href: "project",
    desc: "ABSC innovates with HashTech, Evya AI, and other cloud-based projects, pioneering research and development in the IT domain.",
    imgURL: "/image/activityCard/3.jpeg",
  },
  {
    title: "Annual publication of the club",
    href: "publication",
    desc: "RECURSION 2019 stands as ABSC's yearly publication, showcasing insights, achievements, and contributions in the technology landscape.",
