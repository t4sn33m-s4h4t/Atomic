    ...
    <div className="flex w-full flex-1 flex-col gap-4 md:flex-row lg:w-0 lg:flex-col">
      ...
      <div className="grid flex-1 grid-cols-[1fr_auto] grid-rows-[auto_1fr] gap-3 rounded-xl bg-gray-100 p-4 text-black sm:grid-cols-[3fr_2fr] lg:h-1/2 lg:p-6">
        <div className="col-span-2 flex gap-3">
          <BsCalendar2EventFill className={"h-11 w-11 text-primary"} />
          <div>
            <h3 className="mb-[3.5px] font-Nunito text-2xl font-extrabold leading-none text-primary">
              Science Events
            </h3>
            <p className="text-lg leading-none">Organized by ABSC</p>
          </div>
        </div>
        <div className="col-start-1 row-start-2 flex flex-col self-end sm:gap-2">
          <p className="flex items-center sm:text-lg lg:text-xl">
            ...
            <span className="ml-3 font-extrabold text-primary">
        ...
        <div className="col-start-2 row-start-2 self-end justify-self-end text-right">
          <h3 className="mt-4 text-7xl leading-[0.8] text-primary sm:text-8xl lg:text-[10rem]">
      ...
      <div className="grid flex-1 grid-cols-[1fr_auto] grid-rows-2 items-center gap-4 rounded-xl bg-white lg:h-1/2">
        ...
        <div className="col-start-1 grid h-full grid-cols-[auto_1fr_auto] items-center rounded-lg bg-gray-100 p-3 lg:gap-3 lg:p-6">
          <MdOutlinePeopleOutline
            className={
              "row-start-1 h-10 w-10 self-end text-primary lg:row-start-1 lg:self-center xl:h-14 xl:w-14"
            }
          />
          ...
          <h4 className="row-span-2 justify-self-end text-4xl text-primary lg:row-span-1 xl:text-6xl">
            {AboutData.members}+
          </h4>
        </div>
        ...
        {/* Years Journey Card */}
        <div className="col-start-2 row-span-2 row-start-1 flex aspect-square h-32 w-32 flex-col items-center justify-center rounded-full bg-[conic-gradient(var(--tw-gradient-stops))] from-primary_light to-primary sm:h-40 sm:w-40 2xl:h-44 2xl:w-44">
          <div className="flex h-28 w-28 flex-col items-center justify-center rounded-full bg-white text-center sm:h-36 sm:w-36 2xl:h-40 2xl:w-40">
            <h3 className="text-6xl leading-[.7_!important] text-primary sm:text-7xl 2xl:text-8xl">
              {AboutData.years}
            </h3>
            <p className="text-sm leading-none sm:text-base">
              <span className="text-lg sm:text-2xl">Years</span> <br /> of
              scientific journey
            </p>
          </div>
        </div>
