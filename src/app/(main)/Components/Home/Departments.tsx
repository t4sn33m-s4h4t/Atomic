  ...
  return (
    <div className="mt-16 h-fit w-screen object-cover pb-16 text-center">
      <h1 className="mx-auto mb-5 md:mb-8">
        ...
        <span className="text-center text-4xl text-[#486581] md:text-5xl">
          DEPARTMENTS{" "}
        </span>{" "}
