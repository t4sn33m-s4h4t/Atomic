  ...
  return (
    <li>
      <Link
        href={href}
        className={
          "block rounded px-3 py-2 text-gray-900 lg:p-0 lg:hover:bg-transparent lg:hover:text-primary " +
          (Route === href
            ? "bg-primary text-white hover:bg-primary_dark lg:bg-transparent lg:text-primary "
        ...
        <ul className="Inter container mt-4 flex flex-col gap-1 rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium lg:mt-0 lg:flex-row lg:gap-0 lg:space-x-8 lg:border-0 lg:bg-white lg:p-0 rtl:space-x-reverse">
          ...
          {inClubPage && (
            <>
              ...
              <NavLink href="/club/events">Science Events</NavLink>
            </>
          )}
            ...
            <>
              <Submenu
                ...
                menuItems={[
                  ...
                  {
                    href: "/activities?type=experiment&scroll=true",
                    name: "Experiments",
                  },
                  {
                    href: "/activities?type=research&scroll=true",
                    name: "Research",
                  },
                  {
              ...
              <NavLink href="/executive">Our Team</NavLink>
            </>
          )}
