      ...
      <div className="relative z-50">
        {windowWidth >= 1024 ? (
          ...
          <button
            ...
            data-dropdown-trigger="hover"
            className={
              "flex w-full items-center justify-between gap-1 rounded px-3 py-2 text-left text-gray-900 lg:p-0 lg:hover:bg-transparent lg:hover:text-primary" +
              " " +
              ...
              " " +
              (Route === href
                ? "bg-primary text-white hover:bg-primary_dark lg:text-primary"
            ...
            {menuItems.map((d, i) => {
              return (
                <li key={i}>
                  <Link
                    href={d.href}
                    className="block px-4 py-2 hover:bg-gray-200 lg:hover:bg-gray-100 lg:hover:text-primary"
                  >
                    {d.name}
                  </Link>
                </li>
