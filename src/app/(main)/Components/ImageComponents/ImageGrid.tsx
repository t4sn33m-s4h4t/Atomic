          ...
          return (
            ...
            >
              <img
                ...
                src={url}
                alt="Science Club Activity"
              />
            </a>
          );
        })}
      </div>
      <div className="mr-1 mt-1 cursor-pointer text-right font-medium text-stone-500 hover:text-primary hover:underline">
        <button
          onClick={() => {
            setImageViewerState(true);
          }}
